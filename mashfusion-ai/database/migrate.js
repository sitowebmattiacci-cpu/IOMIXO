...
const SQL_FILES = [
  ...
  path.join(__dirname, 'migrations/011_wedding_pass_24h.sql'),
  path.join(__dirname, 'migrations/012_roulette_penitenze.sql'),
  path.join(__dirname, 'migrations/013_shoe_game_questions.sql'),
